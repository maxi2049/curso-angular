...
export interface RespuestaBusquedaGIF {
    data:       Gif[];
...
export class Convert {
    public static toRespuestaBusquedaGIF(json: string): RespuestaBusquedaGIF {
        return cast(JSON.parse(json), r("RespuestaBusquedaGIF"));
    }

    public static respuestaBusquedaGIFToJson(value: RespuestaBusquedaGIF): string {
        return JSON.stringify(uncast(value, r("RespuestaBusquedaGIF")), null, 2);
    }
}
